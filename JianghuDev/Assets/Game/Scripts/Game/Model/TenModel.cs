...
public class TenModel : BaseModel {


    public static TenModel Inst;
    ...
    /// 游戏状态
    /// </summary>
    public eTenGameState mGameState;
    ...
    /// 玩家信息
    /// </summary>
    public Dictionary<int, TenPlayerInfo> mPlayerInfoDic = new Dictionary<int, TenPlayerInfo>();
    ...
    public void CleanModel(bool depth =false) {
        ...
        mGameState = eTenGameState.Ready;
        if (depth) {
